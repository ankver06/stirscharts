...
const chartFiles = {
  outright: "sonia/outright.json",
  spread3m: "sonia/3m_spread.json",
  spread6m: "sonia/6m_spread.json",
  spread12m: "sonia/12m_spread.json",
  fly3m: "sonia/3m_fly.json",
  fly6m: "sonia/6m_fly.json",
  fly12m: "sonia/12m_fly.json",
  dfly3m: "sonia/3m_double_fly.json",
  dfly6m: "sonia/6m_double_fly.json",
  dfly12m: "sonia/12m_double_fly.json"
};
...
function loadChart(filePath, chartKey) {
  fetch(filePath)
    ...
    .then(data => {
      ...
      titleEl.textContent = `Sonia ${prettyLabel} Curve`;
    ...
    .catch(error => console.error('Error loading Sonia data:', error));
}
...
// ✅ Default load
loadChart('data/sonia/outright.json', 'outright');
